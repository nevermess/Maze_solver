...
pen=serial.Serial('com4',9600) # intializes the serial communication between your python script and arduino
...
c = np.float32(c) 
print(c)
crop = np.float32([[0,600],[600,600],[600,0],[0,0]]) #this is the final orientation we want our
...
imc4=cv2.drawContours(erosion,cnts[0],4,(0,255,0),5)
cv2.imshow("debug",imc4)
